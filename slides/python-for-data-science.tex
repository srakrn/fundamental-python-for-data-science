...
\begin{frame}
    ...
    \centering
    \qrcode[height=2in]{http://bit.ly/cpe-datascience}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \column{0.7\textwidth}
            ...
            \begin{itemize}
                \item Theory Research Group, Kasetsart University
...
\begin{frame}
    ...
    {\onslide<2-> When I say I know \textit{a little} about Python\dots}
    \begin{itemize}[<+(2)->]
        \item I think there are some better methods than I'm using
        \item I sometimes make mistakes
        \item There are tons of people who know things much more than me
        \item I think there are still much more for me to learn!
    \end{itemize}
\end{frame}
    ...
    \begin{columns}[t]
        ...
        \column{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    \item SQL (or at least SQL-like languages)
                    \item Other NoSQL methods
                    \begin{itemize}
                        \item NQL
                        \item Other syntax varies by tools
                    \end{itemize}
                \end{itemize}
            \end{itemize}
    \end{columns}
...
\begin{frame}
    \frametitle{Google Colaboratory (Colab)}
    \centering
    \LARGE \url{https://colab.research.google.com/}
\end{frame}
...
\begin{frame}
    \centering
    \LARGE
    \textit{Today's and tomorrow's importance of Data Science}
\end{frame}

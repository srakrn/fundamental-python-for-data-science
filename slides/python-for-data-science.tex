...
c = [1, "1", True]\end{lstlisting}
        \column{0.5\textwidth}
            \begin{itemize}[<+(1)->]
                ...
                \begin{itemize}
                    \item An extremely oversimplified explanation is to think of arrays in C, but more flexible.
                \end{itemize}
...
\end{lstlisting}
        ...
        \onslide<1-> Accessing list
            \begin{itemize}[<+(2)->]
                ...
                \begin{itemize}
                    \item The syntax, for those familiar, is really like C's array indexing
                \end{itemize}
